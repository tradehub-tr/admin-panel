  ...
  <div>
    ...
    <template v-else>
      ...
      <div v-if="activeTab === 'details'">
        ...
        <div class="card mb-5">
          <h3 class="section-title">
            <i class="fas fa-calendar-check text-emerald-500 mr-2"></i>Dönem Bilgileri
          </h3>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
            <div>
        ...
        <div class="card">
          <h3 class="section-title">
            <i class="fas fa-clock text-amber-500 mr-2"></i>Durum & Zaman
          </h3>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
            <div>
      ...
      <div v-if="activeTab === 'targets'">
        <div class="card mb-5">
          <h3 class="section-title">
            <i class="fas fa-bullseye text-blue-500 mr-2"></i>Hedef & Gerçekleşme
          </h3>
        ...
        <div class="card">
          <h3 class="section-title">
            <i class="fas fa-sliders text-amber-500 mr-2"></i>Eşik Değerleri
          </h3>
      ...
      <div v-if="activeTab === 'benchmark'">
        <div class="card mb-5">
          <h3 class="section-title">
            <i class="fas fa-ranking-star text-purple-500 mr-2"></i>Kıyaslama & Sıralama
          </h3>
        ...
        <div class="card">
          <h3 class="section-title">
            <i class="fas fa-chart-line text-gray-500 mr-2"></i>İstatistik
          </h3>
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
      ...
      <div v-if="activeTab === 'actions'">
        ...
        <div class="card mb-5">
          <h3 class="section-title">
            <i class="fas fa-clipboard-check text-blue-500 mr-2"></i>Aksiyon
          </h3>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
            <div>
              ...
              <div class="mt-1">
                <span
                  ...
                  >{{ doc.action_required ? "Evet" : "Hayır" }}</span
                >
              </div>
            </div>
            <div>
