...
export default {
	...
	"variables": {
		...
		"coded_width": {
			"type": "int",
			"source": "stream.width (rotation öncesi kodlanmış kare)"
		},
		"coded_height": {
			"type": "int",
			"source": "stream.height (rotation öncesi kodlanmış kare)"
		},
		"width": {
			"type": "int",
			"source": "rotation uygulanmış etkin genişlik"
		},
		"height": {
			"type": "int",
			"source": "rotation uygulanmış etkin yükseklik"
		},
		"pixels": {
			"type": "int",
			"source": "width × height"
		...
		"video_start_time_s": {
			"type": "float",
			"source": "video stream.start_time"
		},
		"video_duration_s": {
			"type": "float",
			"source": "video stream.duration; yoksa format.duration"
		},
		"fps": {
			"type": "float",
		...
		"sample_aspect_ratio": {
			"type": "str",
			"source": "stream.sample_aspect_ratio"
		},
		"display_aspect_ratio": {
			"type": "str",
			"source": "stream.display_aspect_ratio; rotation varsa ters çevrilir"
		},
		"pix_fmt": {
			"type": "str",
		...
		"color_transfer": {
			"type": "str",
			"source": "stream.color_transfer"
		},
		"color_primaries": {
			"type": "str",
			"source": "stream.color_primaries"
		},
		"color_space": {
			"type": "str",
			"source": "stream.color_space"
		},
		"is_hdr": {
			"type": "bool",
			"source": "PQ (smpte2084) veya HLG (arib-std-b67) transfer etiketi"
		},
		"has_bframes": {
			"type": "bool",
			"source": "stream.has_b_frames > 0"
		},
		"video_bitrate_bps": {
			"type": "int",
		...
		"audio_start_time_s": {
			"type": "float",
			"source": "audio stream.start_time"
		},
		"audio_duration_s": {
			"type": "float",
			"source": "audio stream.duration; yoksa format.duration"
		},
		"moov_at_end": {
			"type": "bool",
		...
		"error_count": {
			"type": "int",
			"source": "ffprobe -v error stderr satır sayısı; sıfırdan büyükse bozuk/kesik kaynak reddedilir"
		}
	},
	"rules": [
		{
	...
	"qualityGate": {
		...
		"first_frame_luma_min_pct": 1,
		"first_frame_luma_max_pct": 99,
		...
		"duration_note": "Kaynak ile çıktının süresi arasındaki fark. 100 ms üstü fark, A/V ofset değişimi 100 ms üstü veya ilk karenin siyah/beyaz kapıda düşmesi teslim bütünlüğü ihlalidir; çıktı promote edilmeden ATILIR ve kaynak korunur. Ölçülemeyen zorunlu metrik de üretim yolunda kapıyı düşürür."
	},
	"target": {
		"id": "video_1280_h264",
		"maxWidth": 1280,
