  ...
  <div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
      ...
      <div class="flex items-center gap-2 flex-shrink-0 flex-wrap">
        ...
        <button class="hdr-btn-outlined" :disabled="saving" @click="saveDraft">
          <i class="fas fa-floppy-disk mr-1.5 text-xs"></i>Taslak
        </button>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 lg:gap-5">
      ...
      <div class="xl:col-span-2 space-y-5">
        ...
        <div class="card">
          <h3 class="text-sm font-bold text-gray-900 mb-4">
            <i class="fas fa-cube text-violet-500 mr-2"></i>Temel Bilgiler
          </h3>
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                class="form-input"
                placeholder="Örn: Endüstriyel Solvent Grade A - 20L"
              />
            </div>
            <div>
        ...
        <div class="card">
          <h3 class="text-sm font-bold text-gray-900 mb-4">
            <i class="fas fa-images text-blue-500 mr-2"></i>Ürün Görselleri
          </h3>
          <div
          ...
          <div v-if="form.images.length" class="flex gap-3 mt-4 flex-wrap">
            ...
            >
              ...
              <button
                class="absolute top-1 right-1 w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center text-[10px]"
        ...
        <div class="card">
          <h3 class="text-sm font-bold text-gray-900 mb-4">
            <i class="fas fa-tag text-emerald-500 mr-2"></i>Fiyatlandırma & Stok
          </h3>
          ...
          <div class="mt-5 pt-4 border-t border-gray-100">
            <div class="flex items-center justify-between mb-3">
              ...
              <button
                class="text-[11px] font-medium text-violet-600 hover:text-violet-700"
                @click="addTier"
              >
            ...
            <div class="space-y-2">
              <div v-for="(tier, i) in form.priceTiers" :key="i" class="tier-row">
                ...
                <input
                  ...
                  type="number"
                  placeholder="Fiyat ₺"
                  class="form-input-sm w-28"
                />
                <input
                  v-model="tier.discount"
                  type="number"
                  placeholder="%"
                  class="form-input-sm w-20"
                />
                <button
                  class="text-gray-400 hover:text-red-500"
                  @click="form.priceTiers.splice(i, 1)"
                >
        ...
        <div class="card">
          <h3 class="text-sm font-bold text-gray-900 mb-4">
            <i class="fas fa-truck-fast text-orange-500 mr-2"></i>Kargo & Teslimat
          </h3>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
      ...
      <div class="space-y-5">
        ...
        <div class="card">
          <h3 class="text-sm font-bold text-gray-900 mb-4">
            <i class="fas fa-folder-tree text-amber-500 mr-2"></i>Kategori & Marka
          </h3>
          <div class="space-y-3">
            <div>
            ...
            <div>
              ...
              <input
                ...
                type="text"
                class="form-input"
                placeholder="endüstriyel, solvent, 20L"
              />
            </div>
          </div>
        </div>
...
<script setup>
  ...
  async function saveProduct(status) {
    ...
    try {
      ...
      if (status === "Aktif") {
        toast.success(
          hasListing ? "Ürün yayınlandı ve mağazanıza eklendi!" : "Ürün kataloga eklendi!"
        );
      } else {
