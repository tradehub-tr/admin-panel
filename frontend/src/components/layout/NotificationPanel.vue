      ...
      <div class="notif-list">
        ...
        >
          ...
          <div class="notif-content">
            <p class="notif-msg"><strong>{{ n.title }}</strong> {{ n.body }}</p>
            <p class="notif-time">{{ n.time }}</p>
          </div>
          <svg v-if="n.action_url" class="notif-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
        </div>

        <!-- Empty State -->
        <div v-if="filteredNotifications.length === 0" class="notif-empty">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="notif-empty-icon">
...
.dot-blue { background: #7c3aed; }
.dot-green { background: #10b981; }
.dot-amber { background: #f59e0b; }
.dot-red { background: #ef4444; }
.dot-gray { background: #3a3a4a; }
...
.notif-list::-webkit-scrollbar-thumb { background: #2a2a38; border-radius: 2px; }
.notif-list::-webkit-scrollbar-thumb:hover { background: #3a3a4a; }
</style>
