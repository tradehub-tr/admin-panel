    ...
    <div class="mpage__layout" :class="{ 'mpage__layout--detail': Boolean(activeItem) }">
      ...
      <aside class="mrail" :class="{ 'mrail--open': filtersOpen }">
        <MediaFilterRail
          ...
          :original-bytes="store.storage.originalBytes"
          :rendition-bytes="store.storage.renditionBytes"
          :quota-bytes="store.storage.quotaBytes"
          :remaining-bytes="store.storage.remainingBytes"
          :usage-percent="store.storage.usagePercent"
          :quota-mode="store.storage.quotaMode"
          :quota-state="store.storage.quotaState"
          :warning-threshold-percent="store.storage.warningThresholdPercent"
