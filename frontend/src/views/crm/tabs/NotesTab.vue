<template>
  <div>
    <!-- Create new note -->
    <div class="mb-4 p-3 rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5">
      <input
      ...
      <div class="flex justify-end mt-2">
        <button class="hdr-btn-primary" :disabled="saving || !newNote.title.trim()" @click="createNote">
      ...
      >
        <div class="flex items-center justify-between mb-1">
          ...
          <div class="flex items-center gap-2">
            ...
            <button class="text-gray-400 hover:text-rose-500" @click="removeNote(n)" title="Sil">
              <AppIcon name="trash-2" :size="13" />
            </button>
          </div>
        </div>
        <p class="text-[12px] text-gray-600 dark:text-gray-300 whitespace-pre-wrap">{{ n.content }}</p>
