  ...
  <div class="flex gap-4 h-full">
    ...
    <aside class="w-60 flex-shrink-0">
      <div class="th-widget">
        ...
        <div v-else class="space-y-1">
          ...
          >
            <span class="text-sm font-medium" style="color: var(--th-text-primary)">{{
              d.title
            }}</span>
    ...
    <section class="flex-1 min-w-0">
      <div class="th-widget">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-baseline gap-2">
                  ...
                  <span
                    ...
                    style="background: var(--th-surface-card); color: var(--th-text-tertiary)"
                  >
        ...
        <div
          v-if="reorderStatus"
          class="mt-3 text-[11px] text-right"
          :class="reorderStatus.error ? 'text-red-500' : 'text-emerald-500'"
        >
  ...
  async function loadDashboards() {
    ...
    try {
      const res = await api.callMethodGET(
        "tradehub_core.tradehub_core.api.dashboard_engine.list_dashboards"
      );
