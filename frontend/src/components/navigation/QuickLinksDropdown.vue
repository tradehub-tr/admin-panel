<template>
  <Transition name="dropdown">
    <div
      v-if="open"
      class="absolute bottom-[160px] left-[78px] w-[340px] bg-white border border-gray-200 rounded-lg shadow-2xl shadow-black/12 z-[60] overflow-hidden"
      @click.stop
    >
      <div
        class="flex flex-col items-center justify-center py-6 bg-cover bg-center bg-no-repeat relative"
      ...
      <div class="grid grid-cols-2">
        <a
          href="#"
          class="flex flex-col items-center gap-3 py-6 border-r border-b border-gray-100 bg-white hover:bg-gray-50 transition-colors"
          @click.prevent="emit('navigate', '/app/finance')"
        >
        ...
        <a
          href="#"
          class="flex flex-col items-center gap-3 py-6 border-b border-gray-100 bg-white hover:bg-gray-50 transition-colors"
        ...
        <a
          href="#"
          class="flex flex-col items-center gap-3 py-6 border-r border-gray-100 bg-white hover:bg-gray-50 transition-colors"
        ...
        <a
          href="#"
          class="flex flex-col items-center gap-3 py-6 bg-white hover:bg-gray-50 transition-colors"
          @click.prevent="emit('navigate', '/app/customers')"
        >
          <div class="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center">
