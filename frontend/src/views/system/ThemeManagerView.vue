        ...
        <div class="col-span-12 lg:col-span-8 space-y-4">
          <div v-for="group in groups" :key="group.id" class="card">
            ...
            <div class="space-y-3">
              ...
              >
                <label
                  class="col-span-12 sm:col-span-4 text-xs font-semibold text-gray-600 flex items-center gap-2"
                >
                  {{ token.label }}
                  <span
                ...
                <div
                  ...
                  class="col-span-12 sm:col-span-8 flex items-center gap-2"
                >
                  <input
                    type="color"
                ...
                >
                  ...
                  <div class="flex items-center gap-1 flex-shrink-0">
                    <input
                      ...
                      @input="onRangeInput(token, $event)"
                    />
                    <span v-if="token.unit" class="text-[10px] text-gray-400 w-6">{{
                      token.unit
                    }}</span>
                  </div>
                  <button
          ...
          <div v-if="activeTab === 'palette'" class="card bg-amber-50/50 border border-amber-100">
            <div class="flex gap-3">
              <i class="fas fa-circle-info text-amber-500 mt-0.5"></i>
              <div class="text-xs text-amber-900 space-y-1.5">
      ...
      <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-5">
        ...
        <div class="mb-5">
          ...
          <div class="grid grid-cols-11 gap-0.5 rounded overflow-hidden">
            ...
            >
              <span
                class="absolute bottom-0 left-0 right-0 text-center text-[8px] text-white/70 font-mono leading-none pb-0.5"
                >{{ step }}</span
              >
            </div>
          </div>
