...
export const FullCoverage = {
  ...
  args: {
    carrier: "YK",
    rows: [
      "Pending", "Ready for Pickup", "Picked Up", "In Transit", "At Warehouse",
...
export const MultipleCodesPerStatus = {
  ...
  args: {
    ...
    rows: [
      ...ROWS,
      {
        name: "YK-161", carrier: "YK", carrier_status_code: "161",
        carrier_status_text: "Dağıtım aracında", internal_status: ROWS[0]?.internal_status ?? "In Transit",
        exception_code: null,
      },
    ],
    can: { read: true, write: true },
