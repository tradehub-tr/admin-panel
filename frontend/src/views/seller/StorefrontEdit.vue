      ...
      <div v-if="activeTab === 'slider'">
        <div class="card">
          ...
          <div v-if="form.slider_images.length" class="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div
              v-for="(img, i) in form.slider_images"
              :key="i"
            ...
            >
              ...
              <button
                ...
                @click="form.slider_images.splice(i, 1)"
              >
          ...
          <div class="xl:col-span-2 space-y-5">
            ...
            <div class="card">
              ...
              <div v-if="form.factory_images.length" class="flex gap-3 mt-4 flex-wrap">
                <div
                  v-for="(img, i) in form.factory_images"
                  :key="i"
                ...
                >
                  ...
                  <button
                    class="absolute top-1 right-1 w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center text-[10px]"
                    @click="form.factory_images.splice(i, 1)"
                  >
                    <i class="fas fa-xmark"></i>
                  </button>
                </div>
            ...
            <div class="card">
              ...
              <div class="space-y-4">
                ...
                <div
                  ...
                  :class="form.is_published ? 'bg-emerald-50' : 'bg-gray-50'"
                >
                  <i
                    :class="
                      form.is_published
                        ? 'fas fa-globe text-emerald-500'
