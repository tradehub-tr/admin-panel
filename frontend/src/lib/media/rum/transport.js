...
/**
 * UÇ HENÜZ YOK — ölçülmüş durum.
 *
 * `tradehub_core` içinde bu yolu karşılayan bir `@frappe.whitelist()`
 * fonksiyonu ARANDI ve BULUNAMADI. Yol burada bir VARSAYILAN olarak duruyor;
 * uç kurulana kadar her gönderim 404 alır, devre açılır ve toplayıcı susar.
 * Bu bilinçli: uydurma bir uca veri göndermek yerine sessizce durmak.
 *
 * Ucun ne yapması gerektiği raporda alan alan tarif edildi.
 */
export const DEFAULT_ENDPOINT = "/api/method/tradehub_core.api.v1.media_rum.collect";
