      ...
      >
        ...
        >
          ...
          >
            ...
            <button
              class="w-7 h-7 rounded-lg hover:bg-white/10 flex items-center justify-center"
              @click="close"
            >
          ...
          <div class="p-4 space-y-3 border-b" style="border-color: var(--th-border)">
            <div class="relative">
              <i
                class="fas fa-search text-[10px] absolute left-3 top-1/2 -translate-y-1/2"
                style="color: var(--th-text-tertiary)"
              ></i>
              <input
                v-model="search"
...
<script setup>
  ...
  const ICONS = [
    ...
    // Sipariş & E-ticaret
    {
      ...
      label: "Sepet",
      keywords: "sepet alışveriş çanta",
      cat: "Sipariş",
    },
    ...
    {
      fa: "fas fa-arrow-trend-up",
      label: "Yükseliş",
      keywords: "yükseliş trend artış",
      cat: "Analiz",
    },
    {
      fa: "fas fa-arrow-trend-down",
      label: "Düşüş",
      keywords: "düşüş trend azalış",
      cat: "Analiz",
    },
